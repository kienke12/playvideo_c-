...
QT_MOC_LITERAL(1, 7, 13), // "pressedSlider"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "Slider\0pressedSlider\0"
};
...
void Slider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pressedSlider((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Slider::pressedSlider)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Slider::pressedSlider(int _t1)
{
